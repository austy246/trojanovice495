...
const plochy = [
	{
		...
		mistnosti: [
			...
			{ cislo: '1.07', nazev: 'Pokoj', plocha: 12.6, foto: '15-pokoj.jpg' },
			{ cislo: '1.08', nazev: 'Pracovna', plocha: 12.78, foto: '16-pracovna.jpg' },
			{ cislo: '1.09', nazev: 'Ložnice', plocha: 17.12, foto: '17-loznice.jpg' },
			{ cislo: '1.10', nazev: 'Šatna', plocha: 7.25, foto: '18-satna.jpg' },
			{ cislo: '1.11', nazev: 'Koupelna', plocha: 10.36, foto: '19-koupelna.jpg' },
			{ cislo: '1.12', nazev: 'Koupelna', plocha: 3.7, foto: '20-koupelna-mala.jpg' },
			{ cislo: '1.13', nazev: 'Technické zázemí', plocha: 4.72, foto: '21-technicke-zazemi.jpg' },
		],
	},
	{
		podlazi: 'Podkroví',
		mistnosti: [
			{ cislo: '2.01', nazev: 'Galerie', plocha: 33.6, foto: '22-galerie.jpg' },
			{ cislo: '2.02', nazev: 'Pokoj', plocha: 30.6, foto: '23-pokoj-podkrovi.jpg' },
			{ cislo: '2.03', nazev: 'Pokoj', plocha: 23.1, foto: '25-pokoj-podkrovi-3.jpg' },
			{ cislo: '2.04', nazev: 'Pokoj', plocha: 25.75, foto: '24-pokoj-podkrovi-2.jpg' },
			{ cislo: '2.05', nazev: 'Koupelna', plocha: 4.05, foto: '26-koupelna-podkrovi.jpg' },
		],
	},
];
...
export const nemovitost = {
	...
	// Profesionální fotky z 4. 9. 2026 (dron + interiéry). Kompletní set od
	// fotografa, seřazený jako procházka domem: exteriéry, přízemí po
	// místnostech, podkroví, garáž (přízemí i patro) a na konci přehledová
	// fotka s vyznačenými plochami pozemku, domu a garáže.
	galerie: [
		{ soubor: '01-dum-a-pozemek.jpg', popis: 'Dům s garáží uprostřed vlastní louky' },
		{ soubor: '02-dum-a-terasa.jpg', popis: 'Dům ze zahrady s krytou terasou' },
		{ soubor: '03-terasa-posezeni.jpg', popis: 'Posezení na terase' },
		{ soubor: '04-zahrada.jpg', popis: 'Vzrostlá zahrada kolem domu' },
		...
		{ soubor: '11-obytna-hala-3.jpg', popis: 'Obytná hala, pohled k jídelní části' },
		{ soubor: '12-kuchyn.jpg', popis: 'Kuchyň s ostrůvkem a barem' },
		{ soubor: '13-kuchyn-2.jpg', popis: 'Kuchyň, pohled od jídelny' },
		{ soubor: '14-spiz.jpg', popis: 'Spíž' },
		{ soubor: '15-pokoj.jpg', popis: 'Pokoj v přízemí' },
		{ soubor: '16-pracovna.jpg', popis: 'Pracovna' },
		{ soubor: '17-loznice.jpg', popis: 'Ložnice' },
		{ soubor: '18-satna.jpg', popis: 'Šatna s vestavěnou skříní' },
		{ soubor: '19-koupelna.jpg', popis: 'Koupelna s vanou i sprchovým koutem' },
		{ soubor: '20-koupelna-mala.jpg', popis: 'Menší koupelna se sprchou' },
		{ soubor: '21-technicke-zazemi.jpg', popis: 'Technické zázemí' },
		{ soubor: '22-galerie.jpg', popis: 'Galerie v podkroví' },
		{ soubor: '23-pokoj-podkrovi.jpg', popis: 'Pokoj v podkroví' },
		{ soubor: '24-pokoj-podkrovi-2.jpg', popis: 'Další pokoj v podkroví' },
		{ soubor: '25-pokoj-podkrovi-3.jpg', popis: 'Třetí pokoj v podkroví' },
		{ soubor: '26-koupelna-podkrovi.jpg', popis: 'Koupelna v podkroví' },
		{ soubor: '27-garaz.jpg', popis: 'Garáž z ptačí perspektivy' },
		{ soubor: '28-garaz-auto.jpg', popis: 'Garáž pro dva vozy' },
		{ soubor: '29-garaz-dilna.jpg', popis: 'Dílna v garáži' },
		{ soubor: '30-garaz-patro.jpg', popis: 'Podkroví nad garáží' },
		{ soubor: '31-pozemek-oznaceny.jpg', popis: 'Pozemek, dům a garáž s vyznačenými plochami' },
	],
};
